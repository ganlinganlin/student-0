  ...
  routes: [
    route("/index",'/layout',"vlayout"),// /login路径，	
    {
      ...
      children:[ // 其它所有组件都是 Layout的子组件
        ...
        route("/analysis/score",'/score_analysis/score',"score"), //成绩
