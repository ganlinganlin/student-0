		...
		<el-container>
			<el-main style="height: auto;">
				...
				<el-tabs v-model="activeName" @tab-click="stubehavior">
					<el-tab-pane label="校园网数据" name="stuscore">
						<el-container id="stuscoretab">
							<el-header>
								<el-select v-model="value" size="mini" value="2021-2022" @change="changeTyChart" style="float: left;">
											...
											<el-row :gutter="5">
												<el-col :span="8">
													<el-card shadow="hover">
														...
														30.12<span style="font-size: 10px">GB</span>
													</el-card>
												</el-col>
												<el-col :span="8">
													<el-card shadow="hover">
														...
														6<span style="font-size: 10px">天</span>
													</el-card>
												</el-col>
												<el-col :span="8">
													<el-card shadow="hover">
											...
											<el-row :gutter="5">
												<el-col :span="8">
													<el-card shadow="hover">
														...
														180<span style="font-size: 10px">次</span>
													</el-card>
												</el-col>
												<el-col :span="8">
													<el-card shadow="hover">
												...
												<el-col :span="8">
													<el-card shadow="hover">
														...
														<!-- {{studentscore.sports}} -->
														606.5<span style="font-size: 10px">小时</span>
													</el-card>
												</el-col>
											</el-row>
										</el-carousel-item>
